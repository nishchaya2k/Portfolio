      ...
      <section>
        ...
        <div className='flex flex-col md:flex-row justify-center items-center gap-10 md:gap-32 p-4 mt-20'>
          ...
          <motion.div
            ...
            className='h-[300px] w-[300px] rounded-full drop-shadow-2xl border-[17px] border-slate-200 overflow-hidden'>
          ...
          <motion.div
            ...
            className='w-full md:w-4/12 flex flex-col items-center md:items-start'>
            ...
            <div className='flex flex-col items-center justify-center gap-6'>
              <button
                className='w-56 rounded-3xl p-2 border-2 border-[#54CA95]-400 hover:bg-blue-500 hover:text-white transition duration-300 hover:cursor-pointer'
                onClick={() => goToLink("https://www.linkedin.com/in/nishchaya-narula/")}
              >
                Visit LinkedIn
              </button>
              ...
              <button
                className='w-48 rounded-3xl p-2 bg-[#54CA95] hover:bg-[#32be7f] transition duration-300 hover:cursor-pointer'
